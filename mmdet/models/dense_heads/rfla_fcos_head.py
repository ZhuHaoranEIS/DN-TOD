...
class RFLA_FCOSHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        self.use_LNL_loss = use_LNL_loss
        ...
        self.loss_cls_LNL = build_loss(loss_cls_LNL)
    ...
    def loss(self,
        ...
        loss_cls_LNL = self.loss_cls_LNL(
        ...
        if self.use_LNL_loss:
            return dict(
                loss_cls=loss_cls,
                loss_cls_LNL=loss_cls_LNL,
                loss_bbox=loss_bbox,
    ...
    def _get_target_single(self, gt_bboxes, gt_labels, points, rfields, regress_ranges,
        ...
        point_mask = torch.arange(num_gts).repeat(num_points, 1) # num_points, num_gts
